...
def training_args():
    ...
    parser.add_argument(
        '--aug', type=int, default=0, help='data augmentation',
    )
    parser.add_argument(
        '--run', type=int, default=1, help='run number',
    )
    parser.add_argument(
        '--num_samples', type=int, default=None, help='number of samples',
    )
    parser.add_argument(
        '--alpha', type=float, default=2.0, help='alpha divergence parameter',
    )
    parser.add_argument(
        '--reverse', type=int, default=0, help='standard or reverse divergence',
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=('Dataset to train on. '
              'One of {"anhir128", "lysto128", "rotmnist", "cifar10", "food101"}'),
    )

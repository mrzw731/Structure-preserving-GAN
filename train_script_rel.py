"""
Main training script for Structure-preserving GAN using relative-average loss
...
save_folder = (('{}_{}_loss_{}_{}eps_Garch_{}_Darch_{}'
                '_dupdates{}_lrg{}_lrd{}_gp{}_batchsize_{}_aug{}_run{}_numsample{}')
               .format(
                   args.name, args.dataset, args.loss, args.epochs,
                   args.g_arch, args.d_arch, args.d_updates, args.lr_g,
                   args.lr_d, args.gp_wt, args.batchsize, args.aug, args.run, args.num_samples
))
